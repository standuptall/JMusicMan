...
public class FrameDetect extends javax.swing.JFrame {
    ...
    public void listDevices(){
        ...
        for (int i=0;i<roots.length;i++){
            ...
            if (file.exists())
                model.addElement(roots[i]);
        }
        if (model.isEmpty()){
            IO.err(this, "Non sono stati trovati dispositivi.");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameDetect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
